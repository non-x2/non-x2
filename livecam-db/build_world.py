...
やることは build.py と同じ流れの世界版です:
  1. `sources/` の世界の係に「取ってきて」と頼む（いまはアイオワ州・BC州・フィンランド）
...
from sources import base, ca_bc, fi_digitraffic, us_iowa  # noqa: E402
...
COLLECTORS = {
    ...
    "fi-digitraffic": fi_digitraffic.collect_all,
}

# 台帳がこの数を下回ったら「こわれている」とみなして上書きしない（安全装置）
# 内訳の目安：アイオワ州 約790台 ＋ BC州 約1,030台 ＋ フィンランド 約810台 ＝ 約2,630台
MIN_EXPECTED = 2100
